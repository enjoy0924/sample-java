package com.allere.sample.thrift.service;
/**
...
public class TopicService {
  ...
  public interface Iface {
    ...
    public String echo(String displayWords) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void echo(String displayWords, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String echo(String displayWords) throws org.apache.thrift.TException
    {
      send_echo(displayWords);
      return recv_echo();
    }

    public void send_echo(String displayWords) throws org.apache.thrift.TException
    {
      echo_args args = new echo_args();
      args.setDisplayWords(displayWords);
      sendBase("echo", args);
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void echo(String displayWords, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      echo_call method_call = new echo_call(displayWords, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class echo_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public echo_call(String displayWords, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class echo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, echo_args> {
      ...
      public echo_result getResult(I iface, echo_args args) throws org.apache.thrift.TException {
        echo_result result = new echo_result();
        result.success = iface.echo(args.displayWords);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class echo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, echo_args, String> {
      ...
      public void start(I iface, echo_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
        iface.echo(args.displayWords,resultHandler);
      }
    }
  ...
  public static class echo_args implements org.apache.thrift.TBase<echo_args, echo_args._Fields>, java.io.Serializable, Cloneable, Comparable<echo_args>   {
    ...
    private static final org.apache.thrift.protocol.TField DISPLAY_WORDS_FIELD_DESC = new org.apache.thrift.protocol.TField("displayWords", org.apache.thrift.protocol.TType.STRING, (short)1);
    ...
    public String displayWords; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      DISPLAY_WORDS((short)1, "displayWords");
    ...
    static {
      ...
      tmpMap.put(_Fields.DISPLAY_WORDS, new org.apache.thrift.meta_data.FieldMetaData("displayWords", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public echo_args(echo_args other) {
      if (other.isSetDisplayWords()) {
        this.displayWords = other.displayWords;
      }
    }
    ...
    public echo_args setDisplayWords(String displayWords) {
      this.displayWords = displayWords;
      return this;
    }

    public void unsetDisplayWords() {
      this.displayWords = null;
    }

    /** Returns true if field displayWords is set (has been assigned a value) and false otherwise */
    public boolean isSetDisplayWords() {
      return this.displayWords != null;
    }

    public void setDisplayWordsIsSet(boolean value) {
      if (!value) {
        this.displayWords = null;
      }
    }
    ...
    public boolean equals(echo_args that) {
      ...
      boolean this_present_displayWords = true && this.isSetDisplayWords();
      boolean that_present_displayWords = true && that.isSetDisplayWords();
      if (this_present_displayWords || that_present_displayWords) {
        if (!(this_present_displayWords && that_present_displayWords))
          return false;
        if (!this.displayWords.equals(that.displayWords))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_displayWords = true && (isSetDisplayWords());
      list.add(present_displayWords);
      if (present_displayWords)
        list.add(displayWords);
    ...
    public int compareTo(echo_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetDisplayWords()).compareTo(other.isSetDisplayWords());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDisplayWords()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.displayWords, other.displayWords);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("displayWords:");
      if (this.displayWords == null) {
        sb.append("null");
      } else {
        sb.append(this.displayWords);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class echo_argsStandardScheme extends StandardScheme<echo_args> {
          ...
          switch (schemeField.id) {
            case 1: // DISPLAY_WORDS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.displayWords = iprot.readString();
                struct.setDisplayWordsIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, echo_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.displayWords != null) {
          oprot.writeFieldBegin(DISPLAY_WORDS_FIELD_DESC);
          oprot.writeString(struct.displayWords);
          oprot.writeFieldEnd();
        }
